...
class B4cCalorHit : public G4VHit
{
  public:
    ...
    void Add(G4double de, G4double dl, G4ThreeVector hP, G4double GT, G4int NH);
    G4double GetTrackLength() const;
    G4double GetEdep() const;
    G4ThreeVector GetHitPosition() const;
    G4double GetGlobalTime() const;
    G4int GetNHits() const;
...
inline void B4cCalorHit::Add(G4double de, G4double dl, G4ThreeVector hP, G4double GT, G4int NH) {
  fEdep += de; 
  fTrackLength += dl;
  fHitPosition += hP;
  fGlobalTime  += GT;
...
inline G4ThreeVector B4cCalorHit::GetHitPosition() const { 
  return fHitPosition; 
}

inline G4double B4cCalorHit::GetGlobalTime() const {
  return fGlobalTime;
}

inline G4int B4cCalorHit::GetNHits() const {
  return fNHits;
}
